...
public class Test {
	...
	public static MergeSort mergeS = new MergeSort();
	...
	public static void main(String[] args){
        ...
        mergeS.setLoX(myarray0,"<"); // set array & operator
        mergeS.sort();
	...
	public static void tester0 (int lengthArray, boolean printOK, String ope, String gType, int key){
		...
		mergeS.setLoX(myArray,ope);
        mergeS.sort();     
        long finished = System.currentTimeMillis();
        System.out.println("\n\n--------------------------------------------------------\n");
		System.out.println("Generated " + gType +" "+ lengthArray + " array members for merge sort...\n --> " + "Started: " + start + " Finished: " + finished);
		System.out.println("\tProcess time: "+(finished-start) + "ms.");
