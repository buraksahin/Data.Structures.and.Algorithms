...
public class Test {
	...
	public void run() {
		...
		AVL myAVL = new AVL();
		myAVL.insert(new KeyValue(9,"A"));
		myAVL.insert(new KeyValue(4,"B"));
		myAVL.insert(new KeyValue(21,"C"));
		myAVL.insert(new KeyValue(24,"D"));
		myAVL.insert(new KeyValue(33,"E"));
		deletex(myAVL, 33);
		deletex(myAVL, 12);
		deletex(myAVL, 24);
		myAVL.insert(new KeyValue(11,"F"));
		myAVL.insert(new KeyValue(63,"G"));
		myAVL.insert(new KeyValue(43,"I"));
		myAVL.insert(new KeyValue(89,"U"));
		// - Print AVL root - //
